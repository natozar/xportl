...
const s = {
  fab: {
    position: 'fixed', bottom: 'calc(76px + env(safe-area-inset-bottom, 0px))', right: 20,
  ...
  picker: {
    position: 'fixed', bottom: 'calc(134px + env(safe-area-inset-bottom, 0px))', right: 16,
  ...
  sentToast: {
    position: 'fixed', bottom: 'calc(134px + env(safe-area-inset-bottom, 0px))', right: 30,
